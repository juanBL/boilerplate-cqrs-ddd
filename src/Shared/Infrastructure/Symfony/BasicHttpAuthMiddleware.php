...
use BoilerPlate\Backoffice\Auth\Application\Authenticate\AuthenticateUserCommand;
use BoilerPlate\Backoffice\Auth\Domain\InvalidAuthCredentials;
use BoilerPlate\Backoffice\Auth\Domain\InvalidAuthUsername;
...
final class BasicHttpAuthMiddleware
{
    ...
    {
        $event->setResponse(
            new Response('', Response::HTTP_UNAUTHORIZED, ['WWW-Authenticate' => 'Basic realm="BoilerPlate"'])
        );
    }
}
