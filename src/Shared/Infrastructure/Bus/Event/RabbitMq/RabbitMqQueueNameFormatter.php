...
namespace BoilerPlate\Shared\Infrastructure\Bus\Event\RabbitMq;

use BoilerPlate\Shared\Domain\Bus\Event\DomainEventSubscriber;
use BoilerPlate\Shared\Domain\Utils;
...
final class RabbitMqQueueNameFormatter
{
    ...
    {
        $subscriberClassPaths = explode('\\', str_replace('BoilerPlate', 'boilerplate', get_class($subscriber)));
